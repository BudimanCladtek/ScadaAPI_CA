...
namespace CORSYS_API.Models
{
    public class ClsSql
    {
        ...
        public void OpenConn()
        {
            ...
            string connetionString = ConfigurationManager.AppSettings["ConnStrCORSys"].ToString();
        ...
        public AuthModel CheckDB(AuthModel AM)
        {
            if (AM.DBName == null)
            {
                if (AM.isLive)
        ...
        public SqlDataReader GetDataReaderSQL(string query)
        {
            try
            {
                OpenConn();
        ...
        public DataTable GetDataTableSQL(string query)
        {
            try
            {
                OpenConn();
